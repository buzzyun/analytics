...
public class KeywordRankDiffHandler extends ProcessHandler {
	...
	public KeywordRankDiffHandler(File rankLogFile, File compareRankLogFile, int topCount, String encoding){
	...
	public Object process(Object parameter) throws Exception {
		 ...
		 * 없으면 new, 있으면 +/- 순위변동값.
		 */
		KeywordLogRankDiffer differ = new KeywordLogRankDiffer(rankLogFile, compareRankLogFile, topCount, encoding);
