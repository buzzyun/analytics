...
public class AggregationResultDatabaseWriter implements AggregationResultWriter {
	private File file;
	private Writer writer;
	private int minimumCount; //유효한 최소 검색횟수. 이 횟수보다 작으면 기록하지 않는다.
	 
	public AggregationResultDatabaseWriter(File file, String encoding) {
		this(file, encoding, 0);
	}
	public AggregationResultDatabaseWriter(File file, String encoding, int minimumCount) {
		this.file = file;
		try {
