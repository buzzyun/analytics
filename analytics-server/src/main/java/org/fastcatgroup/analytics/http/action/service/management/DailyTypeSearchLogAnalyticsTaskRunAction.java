...
@ActionMapping("/management/run/daily-type-log-analytics-task")
public class DailyTypeSearchLogAnalyticsTaskRunAction extends ServiceAction {
	...
	public void doAction(ActionRequest request, ActionResponse response) throws Exception {
		...
		try {
			...
			DailyTypeSearchLogAnalyticsTask task = new DailyTypeSearchLogAnalyticsTask(siteId, categoryIdList, schedule, 0);
