...
echo fastcat-analytics start. see log at logs/system.log and output.log

%java_path% -Dserver.home=%server_home% %JVM_OPTS% %JAVA_OPTS% %ADDITIONAL_OPTS% -classpath %LIB%/analytics-server-bootstrap.jar org.fastcatsearch.analytics.server.Bootstrap start > %OUTPUT_LOG%
